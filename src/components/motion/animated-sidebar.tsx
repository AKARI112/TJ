  ...
  return (
    <button
      ...
      className={cn(
        ...
        "after:absolute after:inset-y-0 after:start-1/2 after:w-px after:bg-transparent after:transition-colors hover:after:bg-border",
        "data-[side=right]:right-0 data-[side=right]:translate-x-1/2 rtl:data-[side=right]:-translate-x-1/2 data-[side=left]:left-full",
        className,
      )}
    />
  );
  ...
  return (
    <motion.main
      ...
      className={cn(
        ...
        "md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ms-0 md:peer-data-[variant=inset]:rounded-2xl md:peer-data-[variant=inset]:shadow-sm",
        className,
      )}
    />
  );
    ...
    <AnimatePresence initial={false} mode="popLayout">
      {open && !panel.collapsed ? (
        <motion.ul
          ...
          className={cn(
            "relative mt-1 ms-5 flex min-w-0 flex-col gap-0.5 border-border border-s ps-3",
            className,
          )}
        >
          {children}
