    ...
    <>
      ...
      >
        <div
          ...
          aria-hidden
          className={cn(
            "pointer-events-none invisible absolute start-0 top-0 grid w-max px-2 pt-2",
            classNames?.panel,
          )}
        ...
        <div
          className={cn(
            "absolute start-0 end-0 top-0 z-10 overflow-hidden px-2 pt-2",
            classNames?.panel,
          )}
        ...
        <div
          ...
          className={cn(
            "absolute bottom-0 start-0 z-20 flex w-full items-center justify-between gap-1 p-2",
            classNames?.bar,
          )}
          style={{ height: BAR_H }}
        >
            ...
            return (
              <motion.button
                ...
                className={cn(
                  ...
                  active && isActive && "min-w-0 justify-start ps-2.5 pe-4",
                  isActive
                    ? "text-foreground"
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none fixed start-0 top-0 -z-10 flex opacity-0"
      >
        {items.map((item) => (
          <span
            className={cn(
